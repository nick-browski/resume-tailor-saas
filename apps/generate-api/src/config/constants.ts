...
export const MATCH_CHECK_CONFIG = {
  PROMPT_TEMPLATE: `You are a professional recruiter analyzing the compatibility between a resume and a job description.
...
Job description:
{jobText}`,
  PROMPT_PLACEHOLDER_RESUME_TEXT: "{resumeText}",
  PROMPT_PLACEHOLDER_JOB_TEXT: "{jobText}",
