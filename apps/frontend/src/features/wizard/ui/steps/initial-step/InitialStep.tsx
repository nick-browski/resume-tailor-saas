...
export function InitialStep({
  ...
  const { refs, steps: tourSteps } = useTourSteps({
    editButton: {
      ...
      content:
        "Click here to edit your existing resume. Make changes to your experience, skills, or any section.",
      position: "right",
    },
    tailorButton: {
      title: "Tailor to Job Description",
      content:
        "Click here to tailor your resume to a specific job description. We'll optimize it to match the requirements.",
      position: "right",
    },
    uploadArea: {
      title: "Upload Your Resume",
      content:
        "Drag and drop your PDF resume here or click to browse. You can also paste your resume text.",
      position: "top",
    },
  });
    ...
    <>
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        {uploadMode === UPLOAD_MODE.FILE && (
          <div>
            ...
            {resumeData?.file ? (
              ...
              <div className="space-y-3">
                <TourTarget ref={refs.uploadArea}>
                  <FileUploadArea
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-end pt-4">
          <TourTarget ref={refs.editButton}>
            <button
              type="button"
          ...
          <TourTarget ref={refs.tailorButton}>
            <button
              type="button"
