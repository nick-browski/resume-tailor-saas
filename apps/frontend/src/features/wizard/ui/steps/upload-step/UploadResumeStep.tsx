...
export function UploadResumeStep({
  ...
  const { refs, steps: tourSteps } = useTourSteps({
    uploadArea: {
      ...
      content:
        "Upload your PDF resume or paste the text here. This will be used to generate your tailored resume.",
      position: "top",
    },
    nextButton: {
      title: "Continue to Job Description",
      content:
        "Click here to proceed to the next step where you'll enter the job description.",
      position: "top",
    },
  });
  ...
  return (
    <>
      <Tour steps={tourSteps} storageKey="resume-tailor-tour-upload-step" />
      <form onSubmit={handleFormSubmit} className="space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-3 pt-4">
          ...
          <TourTarget ref={refs.nextButton}>
            <button
              type="submit"
              disabled={isGenerationInProgress}
